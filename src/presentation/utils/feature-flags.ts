...
function exposeToConsole(): void {
    ...
    const examples = methods
        ...
        .join(", ");
    console.log(`🚩 Feature Flags available! Methods: featureFlags.list(), featureFlags.getFlags(), ${examples}`);
}
...
export const getFeatureFlagManager = (): typeof FeatureFlagManager => FeatureFlagManager;
