...
export function createContact(data: ContactForCreate, generateUUID: () => string): Result<Contact, Error> {
...
export function updateContact(contact: Contact, updates: ContactForUpdate): Contact {
    return {
        ...contact,
        ...updates,
