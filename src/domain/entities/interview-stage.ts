...
export type InterviewStageId = typeof interviewStageModule.InterviewStageId.infer;
...
export type InterviewStageForCreate = typeof interviewStageModule.forCreate.infer;
export type InterviewStageForUpdate = typeof interviewStageModule.forUpdate.infer;
export function createInterviewStage(data: InterviewStageForCreate, generateUUID: () => string): Result<InterviewStage, Error> {
...
export function createInterviewStageId(generateUUID: () => string): InterviewStageId {
    return interviewStageModule.InterviewStageId.assert(generateUUID());
}
export function updateInterviewStage(stage: InterviewStage, updates: InterviewStageForUpdate): InterviewStage {
    return {
        ...stage,
        ...updates,
